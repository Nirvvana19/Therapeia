...
import com.example.therapeia.data.Alarmtone
import com.example.therapeia.data.Layout
...
import com.example.therapeia.platform.checkPermissions
import com.example.therapeia.ui.main.AlarmsListActivity
import com.example.therapeia.ui.ringtonepicker.getPickedRingtone
import com.example.therapeia.ui.ringtonepicker.showRingtonePicker
import com.example.therapeia.ui.ringtonepicker.userFriendlyTitle
import com.example.therapeia.ui.row.ListRowHighlighter
import com.example.therapeia.ui.row.RowHolder
import com.example.therapeia.ui.state.BackPresses
import com.example.therapeia.ui.state.EditedAlarm
import com.example.therapeia.ui.themes.resolveColor
import com.example.therapeia.ui.timepicker.PickedTime
  ...
  private fun onCreateRepeatView() {
    ...
    observeEditor { alarmValue ->
      ...
      repeatSummary.setTextColor(
          requireActivity()
              .theme
              .resolveColor(if (valid) android.R.attr.colorForeground else org.koin.android.R.attr.colorError))
    }
  }
