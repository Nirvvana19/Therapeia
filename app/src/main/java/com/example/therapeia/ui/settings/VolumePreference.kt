...
import com.example.therapeia.data.Prefs.Companion.MAX_PREALARM_VOLUME
import com.example.therapeia.services.KlaxonPlugin
import com.example.therapeia.services.PluginAlarmData
import com.example.therapeia.services.TargetVolume
import com.example.therapeia.util.subscribeIn
...
class VolumePreference(mContext: Context, attrs: AttributeSet) : Preference(mContext, attrs) {
  ...
  /** Called from [com.example.therapeia.presenter.SettingsFragment.onPause] */
  fun onPause() {
    stopMasterSample()
    stopPrealarmSample()
  }
